...
<script type="text/javascript" ><%@ include file="mypage.js" %></script>  
  <article>
    <h2> Cart List </h2>
    ...
    <c:otherwise>
      <table id="cartList">
        ...
        <tr>      
          <td>
            <a href="ProductMarket?command=product_detail&pseq=${cartVO.pseq}">
              <h3> ${cartVO.pname} </h3>              
            </a>    
          </td>
...
onclick="location.href='ProductMarket?command=index'">    
